...
const AllProducts = () => {
  ...
  const removeFromCartAndDelete = (productId: string) => {
    const deletedProduct: any = cart.products.filter(
              ...
              {currentProducts.map((product: Product) => (
                <>
                  ...
                  <tr
                    ...
                    key={product._id}
                  >
                    <td className=" border-b 300">{product.title}</td>
                    <td className=" flex justify-center">
                      <div className=" bg-gray-100">
                        {product.img && (
                          <img src={product.img[0]} className=" w-16 " />
                        )}
                      </div>
                    </td>
                    <td className=" border-b 300">{product.category}</td>
                    <td className=" border-b 300">{product.price}</td>
