...
const UpdateAccount = () => {
    ...
    const { mutate: createProduct, error: err } = useCreateProduct(onSuccess, onError);
    ...
    const initialValues = {
        title: '', desc: '', price: '', category: '', collection: '', size: [''], color: [''], discountPrice: '', offer: ''
    }
    ...
    return (
        <div className="flex flex-col sm:flex-row min-h-screen gap-2 xl:gap-10 text-xs w-full justify-evenly mb-20">
                                ...
                                >
                                    ...
                                    <div className="flex gap-10 mb-10">
                                        ...
                                        <div className=" flex gap-4">
                                            ...
                                            <select name="collection" value={props.values.collection} onChange={props.handleChange} onBlur={props.handleBlur} className=" bg-white" disabled={!props.values.category}>
                                                <option value="" disabled>select</option>
                                    ...
                                    <div className="flex items-center w-full justify-end">
                                        <p>Featured</p>
                                        <Checkbox size="small" onChange={() => setIsChecked(current => !current)} />
                                    </div>
                                    <button
            ...
            <div className={`items-start flex sm:flex-col xl:flex-row justify-evenly w-fit overflow-hidden relative  ${!images ? "items-center" : ""} mt-10 h-fit w-fit`}>
                ...
                <div className="p-2 opacity-80 flex items-start gap-4  flex-col w-[200px] xl:w-[300px] justify-center">
                    <div className="flex items-center gap-4 w-fit border-b h-14 border-green-500 p-2">
                        <p>Upload Cover</p>
                        <IconButton>
                            <input className=" absolute w-10 opacity-0" type="file" onChange={coverImgHandler} />
                            <PhotoCamera />
                        </IconButton>
                    </div>
