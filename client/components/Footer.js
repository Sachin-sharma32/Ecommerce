...
const Footer = () => {
    return (
        <div className=" p-10 grid grid-cols-3 gap-4 justify-items-center pb-10 text-sm items-center">
            ...
            <div className="flex flex-col gap-4 items-center text-center border-r-2 p-4 w-full">
