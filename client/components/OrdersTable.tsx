...
const OrdersTable = ({ orders, admin, status }: AppProps) => {
    ...
    "👉 ~ file: OrdersTable.tsx:27 ~ OrdersTable ~ filterOrders", filterOrders;
            ...
            {filterOrders?.map((order) => (
                ...
                >
                    ...
                    <div className="w-full flex justify-evenly border-t">
                        ...
                        {order.status === "delivered" && (
                            <button className=" cursor-default uppercase w-full border-r bg-green-200 transition-all duration-200">
                                Order Delivered
                            </button>
                        )}
