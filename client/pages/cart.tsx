...
const Cart = () => {
  ...
  return (
    <Smooth className=" min-h-screen mt-[6rem] px-10 text-sm mb-20">
      ...
      <h1 className=" w-fit m-auto text-2xl font-semibold sticky">YOUR CART</h1>
                ...
                >
                  ...
                  <div className="w-full flex justify-evenly border-t">
                    <button
                      ...
                      onClick={() => {
                        removeProductFromCart(item.product._id, item.quantity);
                      }}
                    >
                      Remove
                    </button>
          ...
          <div className=" border w-fit p-4 flex flex-col gap-4 justify-center text-left rounded-sm h-fit sticky top-20">
            ...
            <table className="border border-collapse">
              ...
              <tr className="text-black">
                ...
                <td className="w-32 p-2 text-left border bg-gray-100 font-extrabold text-black">
                  Total
                </td>
                <td className=" w-32 p-2 text-left mt-10 border bg-gray-100 font-extrabold text-black">
                  {total}
                </td>
              </tr>
            </table>
