            ...
            <div className="flex flex-col gap-10 details">
              <div className="flex flex-col gap-4">
                ...
                <div className="flex gap-4">
                  ...
                  <p className=" border px-2 rounded-sm">{quantity}</p>
                  <div
                    onClick={() => {
              ...
              {productRatings?.length > 0 ? (
                <div className="flex flex-col gap-20">
                  ...
                  <div className="flex flex-col gap-2">
                    <div>
                      <p className=" text-lg">
                        Customer Images ({ratingImages.length})
                      </p>
                    </div>
                    <div className="grid grid-cols-5 gap-2">
                      {limitImages?.map((img, index) => (
                        <button
                          ...
                          onClick={() => setSelectedImages(ratingImages)}
                        >
                          <img
                            src={img}
                            className="w-20 h-20 rounded-lg"
                      ...
                      <div
                        ...
                        onClick={() => setSelectedImages(ratingImages)}
                      >
                        <p className=" w-fit">See All Images</p>
                      </div>
                    </div>
                  </div>
                </div>
              ) : (
                <div className=" w-fit p-2 bg-gray-200 text-black">
                  No Reviews Yet
                </div>
              )}
            </div>
...
export async function getServerSideProps(context) {
  ...
  return {
    props: {
      title: `${context.params.product[0]}`,
      image: "/shremz.png",
      summery:
      ...
      type: "website",
      imageAlt: "Shremz",
      parameter: `/product/${context.params.product[0]}`,
      productId: context.params.product[0],
    },
  };
}
