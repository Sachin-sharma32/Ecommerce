...
const CreateCollection = ({ productId }) => {
  ...
  const { mutate: createRating, error: err } = useCreateRating(
    onSuccess,
    onError
  );
  ...
  return (
    <div className="flex min-h-screen px-4 gap-10 text-normal mx-auto w-fit justify mb-20 mt-[6rem]">
...
export async function getServerSideProps(context) {
  ...
  return {
    props: {
      ...
      type: "website",
      imageAlt: "Shremz",
      parameter: `/rating/${context.params.product[0]}`,
