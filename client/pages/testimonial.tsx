...
const CreateCategory = () => {
  ...
  return (
    <div className="flex flex-col sm:flex-row min-h-screen gap-10 text-normal justify-center items-center mb-20 mx-auto bg-gradient-to-r from-gray-50 to-gray-100">
      ...
      <div className=" flex flex-col gap-10 w-[500px] items-center">
        <div>
          ...
          <p className=" text-black">
            Help our business grow by sharing your experience shopping with us.
          </p>
        </div>
        <Formik
...
CreateCategory.getInitialProps = async () => {
  return {
    title: "testimonial",
    image: "/shremz.png",
    summery:
